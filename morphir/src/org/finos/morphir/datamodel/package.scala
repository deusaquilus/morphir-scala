...
package object datamodel {
  ...
  implicit def optionNoneDeriver: SpecificDeriver[scala.None.type] = new SpecificDeriver[scala.None.type] {
  ...
  ): SpecificDeriver[LinkedHashMap[K, V]] = new SpecificDeriver[LinkedHashMap[K, V]] {
  ...
  implicit def listMapDeriver[K, V](implicit
      keyDeriver: Deriver[K],
      valueDeriver: Deriver[V]
  ): SpecificDeriver[ListMap[K, V]] = new SpecificDeriver[ListMap[K, V]] {
  ...
  implicit def mapDeriver[K, V](implicit
      keyDeriver: Deriver[K],
      valueDeriver: Deriver[V]
  ): SpecificDeriver[Map[K, V]] = new SpecificDeriver[Map[K, V]] {
